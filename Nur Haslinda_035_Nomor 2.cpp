...
int main()
{
	...
	cout<<"Panjang "<<kota1<<" ke "<<kota2<< ": "; 
	cin>> hasil1;
	cout<<"Panjang "<<kota1<<" ke "<<kota4<< ": "; 
	cin>> hasil2;
	cout<<"Panjang "<<kota1<<" ke "<<kota5<< ": "; 
	cin>> hasil3;
	cout<<"Panjang "<<kota2<<" ke "<<kota3<< ": "; 
	cin>> hasil4;
	cout<<"Panjang "<<kota3<<" ke "<<kota5<< ": "; 
	cin>> hasil5;
	cout<<"Panjang "<<kota3<<" ke "<<kota4<< ": "; 
	cin>> hasil6;
	cout<<"Panjang "<<kota4<<" ke "<<kota5<< ": "; 
	cin>> hasil7;
